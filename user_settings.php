...
echo "
<div id='regbox'>
<center><form name='updateAccount' action='".$_SERVER['PHP_SELF']."' method='post'>
<p>
...
<p>
<label>Email:</label>
<input type='text' name='email' value='".$loggedInUser->email."' id='new'/>
</p>
<p>
<label>New Pass:</label>
<input type='password' name='passwordc' id='new'/>
</p>
<p>
<label>Confirm Pass:</label>
<input type='password' name='passwordcheck' id='new'/>
</p>
<p>
<label>&nbsp;</label>
